        ...
        {isLoggedIn ? (
          <>
            <span className="hidden sm:inline text-text-secondary">
              Hello, <span className="font-semibold text-text-primary">{user?.firstName}</span>!
            </span>
            <button
          ...
          <div className="flex gap-3 items-center">
            <Link to="/login" className="px-4 py-2 text-text-secondary hover:text-text-primary transition-colors font-medium">
              Login
            </Link>
            <Link
              to="/signup"
